...
"[project]/app/types/event.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data/events.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/context/DataContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/data/events.ts [app-client] (ecmascript)");
;
...
function DataProvider({ children }) {
    ...
    const persistedEvents = ("TURBOPACK compile-time truthy", 1) ? loadFromStorage(EVENTS_STORAGE_KEY, null) : "TURBOPACK unreachable";
    const initialData = persistedEvents ?? __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["events"];
    const [events, setEvents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialData);
    const [deletedEvents, setDeletedEvents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>loadFromStorage(DELETED_STORAGE_KEY, [])
    }["DataProvider.useState"]);
    const [suggestionConfig, setSuggestionConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>loadFromStorage(SUGGESTION_STORAGE_KEY, {
                prompt: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$types$2f$event$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_SUGGESTION_PROMPT"]
            })
    }["DataProvider.useState"]);
    const [apiKeys, setApiKeys] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>loadFromStorage(APIKEYS_STORAGE_KEY, [])
    }["DataProvider.useState"]);
    ...
    const syncHistoryState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[syncHistoryState]": ()=>{
    ...
    const pushHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[pushHistory]": (newEvents)=>{
    ...
    }["DataProvider.useCallback[pushHistory]"], [
        syncHistoryState
    ]);
    ...
    /* ---------- Persist side effects ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    /* ---------- Event CRUD ---------- */ const addEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[addEvent]": (event)=>{
            const newEvent = {
                ...event,
                id: generateId()
            };
            setEvents({
                "DataProvider.useCallback[addEvent]": (prev)=>{
                    const next = [
                        ...prev,
                        newEvent
                    ];
            ...
            }["DataProvider.useCallback[addEvent]"]);
        }
    }["DataProvider.useCallback[addEvent]"], [
        pushHistory
    ]);
    const updateEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[updateEvent]": (event)=>{
            setEvents({
                "DataProvider.useCallback[updateEvent]": (prev)=>{
                    const next = prev.map({
                        "DataProvider.useCallback[updateEvent].next": (ev)=>ev.id === event.id ? event : ev
                    }["DataProvider.useCallback[updateEvent].next"]);
                    pushHistory(next);
                    return next;
                }
            }["DataProvider.useCallback[updateEvent]"]);
        }
    }["DataProvider.useCallback[updateEvent]"], [
        pushHistory
    ]);
    const updateEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[updateEvents]": (updated)=>{
            setEvents({
                "DataProvider.useCallback[updateEvents]": (prev)=>{
                    const map = new Map(prev.map({
                        "DataProvider.useCallback[updateEvents]": (e)=>[
                                e.id,
                                e
                            ]
                    }["DataProvider.useCallback[updateEvents]"]));
                    updated.forEach({
                        "DataProvider.useCallback[updateEvents]": (u)=>map.set(u.id, u)
                    }["DataProvider.useCallback[updateEvents]"]);
    ...
    const deleteEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[deleteEvent]": (id)=>{
            setEvents({
                "DataProvider.useCallback[deleteEvent]": (prev)=>{
                    const next = prev.filter({
                        "DataProvider.useCallback[deleteEvent].next": (ev)=>ev.id !== id
                    }["DataProvider.useCallback[deleteEvent].next"]);
                    pushHistory(next);
                    return next;
                }
            }["DataProvider.useCallback[deleteEvent]"]);
        }
    }["DataProvider.useCallback[deleteEvent]"], [
        pushHistory
    ]);
    const deleteEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[deleteEvents]": (ids)=>{
            const idSet = new Set(ids);
            setEvents({
                "DataProvider.useCallback[deleteEvents]": (prev)=>{
                    const next = prev.filter({
                        "DataProvider.useCallback[deleteEvents].next": (ev)=>!idSet.has(ev.id)
                    }["DataProvider.useCallback[deleteEvents].next"]);
                    pushHistory(next);
                    return next;
                }
            }["DataProvider.useCallback[deleteEvents]"]);
        }
    }["DataProvider.useCallback[deleteEvents]"], [
        pushHistory
    ]);
    const importEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[importEvents]": (imported)=>{
            setEvents({
                "DataProvider.useCallback[importEvents]": (prev)=>{
                    const map = new Map(prev.map({
                        "DataProvider.useCallback[importEvents]": (e)=>[
                                e.title,
                                e
                            ]
                    }["DataProvider.useCallback[importEvents]"]));
                    imported.forEach({
                        "DataProvider.useCallback[importEvents]": (item)=>{
    ...
    /* ---------- Trash operations ---------- */ const moveToTrash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[moveToTrash]": (ids)=>{
            const idSet = new Set(ids);
            setEvents({
                "DataProvider.useCallback[moveToTrash]": (prev)=>{
                    const toTrash = prev.filter({
                        "DataProvider.useCallback[moveToTrash].toTrash": (ev)=>idSet.has(ev.id)
                    }["DataProvider.useCallback[moveToTrash].toTrash"]);
                    const next = prev.filter({
                        "DataProvider.useCallback[moveToTrash].next": (ev)=>!idSet.has(ev.id)
                    }["DataProvider.useCallback[moveToTrash].next"]);
                    setDeletedEvents({
                        "DataProvider.useCallback[moveToTrash]": (trash)=>[
                                ...trash,
                                ...toTrash
                            ]
                    }["DataProvider.useCallback[moveToTrash]"]);
                    pushHistory(next);
                    return next;
                }
            }["DataProvider.useCallback[moveToTrash]"]);
    ...
    const restoreFromTrash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[restoreFromTrash]": (ids)=>{
            const idSet = new Set(ids);
            setDeletedEvents({
                "DataProvider.useCallback[restoreFromTrash]": (prev)=>{
                    const toRestore = prev.filter({
                        "DataProvider.useCallback[restoreFromTrash].toRestore": (ev)=>idSet.has(ev.id)
                    }["DataProvider.useCallback[restoreFromTrash].toRestore"]);
                    const nextTrash = prev.filter({
                        "DataProvider.useCallback[restoreFromTrash].nextTrash": (ev)=>!idSet.has(ev.id)
                    }["DataProvider.useCallback[restoreFromTrash].nextTrash"]);
                    setEvents({
                        "DataProvider.useCallback[restoreFromTrash]": (evs)=>{
                            // Avoid duplicates: skip if already exists in events
                            const existingIds = new Set(evs.map({
                                "DataProvider.useCallback[restoreFromTrash]": (e)=>e.id
                            }["DataProvider.useCallback[restoreFromTrash]"]));
                            const uniqueRestored = toRestore.filter({
                                "DataProvider.useCallback[restoreFromTrash].uniqueRestored": (e)=>!existingIds.has(e.id)
                            }["DataProvider.useCallback[restoreFromTrash].uniqueRestored"]);
                            const next = [
                                ...evs,
                                ...uniqueRestored
                            ];
    ...
    const permanentlyDeleteFromTrash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[permanentlyDeleteFromTrash]": (ids)=>{
            const idSet = new Set(ids);
            setDeletedEvents({
                "DataProvider.useCallback[permanentlyDeleteFromTrash]": (prev)=>prev.filter({
                        "DataProvider.useCallback[permanentlyDeleteFromTrash]": (ev)=>!idSet.has(ev.id)
                    }["DataProvider.useCallback[permanentlyDeleteFromTrash]"])
            }["DataProvider.useCallback[permanentlyDeleteFromTrash]"]);
        }
    }["DataProvider.useCallback[permanentlyDeleteFromTrash]"], []);
    /* ---------- Suggestion config ---------- */ const updateSuggestionPrompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[updateSuggestionPrompt]": (prompt)=>{
            setSuggestionConfig({
                "DataProvider.useCallback[updateSuggestionPrompt]": (prev)=>({
                        ...prev,
                        prompt
                    })
            }["DataProvider.useCallback[updateSuggestionPrompt]"]);
        }
    }["DataProvider.useCallback[updateSuggestionPrompt]"], []);
    /* ---------- API Key management ---------- */ const addApiKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[addApiKey]": (config)=>{
            const newKey = {
                ...config,
                id: generateApiKeyId(),
            ...
            setApiKeys({
                "DataProvider.useCallback[addApiKey]": (prev)=>[
                        ...prev,
                        newKey
                    ]
            }["DataProvider.useCallback[addApiKey]"]);
        }
    }["DataProvider.useCallback[addApiKey]"], []);
    const deleteApiKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[deleteApiKey]": (id)=>{
            setApiKeys({
                "DataProvider.useCallback[deleteApiKey]": (prev)=>prev.filter({
                        "DataProvider.useCallback[deleteApiKey]": (k)=>k.id !== id
                    }["DataProvider.useCallback[deleteApiKey]"])
            }["DataProvider.useCallback[deleteApiKey]"]);
        }
    }["DataProvider.useCallback[deleteApiKey]"], []);
...
_s(DataProvider, "MZdAlUtwL0sKqTdkgXTNqyZsVZ8=");
_c = DataProvider;
function useData() {
    _s1();
...
//# sourceMappingURL=_0ex9af1._.js.map